...
return [
    ...
    */
    ...
    'providers' => [
        'users' => [
            'driver' => 'eloquent',
            'model' => App\Models\Portal\PortalAuth\User::class,
        ],
        ...
        //Advertiser user provider
        'advertiser_users' => [
            'driver' => 'eloquent',  //We are using eloquent model
            'model' => App\Models\Advertiser\AdvertiserAuth\AdvertiserUser::class,
        ],
    ...
    */
    ...
    'passwords' => [
       ...
       'advertiser_users' => [
           ...
           'table' => 'advertiser_user_password_resets',
